...
/// <summary>
/// Shared scaffold for the encounter controller. Centralises the JSON
/// envelope, body deserialisation, and actor extraction so the leaf
/// controller only declares its route, tags, and action signatures.
/// </summary>
public abstract class EncounterControllerBase(
    IHttpContextAccessor httpContextAccessor) : ControllerBase
{
    ...
    /// <typeparam name="T">The concrete DTO type to materialise.</typeparam>
