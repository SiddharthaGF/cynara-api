...
license: MIT
metadata:
    enhancements: Multi-language manifest detection, CI/CD pipeline detection, container & orchestration detection, code metrics, security & compliance config detection, performance testing markers
